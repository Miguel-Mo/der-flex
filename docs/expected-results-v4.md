...
- pytest sin PostgreSQL: 134 pruebas superadas, 23 omitidas y un aviso upstream
  Starlette/AnyIO. Con `DER_FLEX_TEST_DATABASE_URL`: 157 pruebas superadas.
...
- trazabilidad: 20 claims y 112 referencias válidas.
